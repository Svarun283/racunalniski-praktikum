...
Program za izdelavo urnika\section{$1}
...
\[\cdot\text{velikostTabele = številoUrNaDan · številoDelovnihDni}
matematični\ izraz
\]
...
Merjenje kakovosti \subsection{$1}
...
(skoraj) vedno `odloči', da jih ne bo prekršil. Tak način uteževanja pride v poštev
...
kakovost urnika:
\[\cdot\text{k1 · u1 + k2 · u2 + . . . + kn−1 · un−1 + kn · un}
matematični\ izraz
\]
...
Avtomatizirana izdelava urnika \section{$1}
...
Optimizacijske metode \subsection{$1}
...
Lokalno vzpenjanje \subsubsection{$1}
...
Iskanje s tabuji \subsubsection{$1}
